...
for refrigerant in refrigerantList
    ...
    filePath=joinpath(pwd(), "calculations", "situation2","rf$(refrigerant)")
    ...
    for heatStorageHour in 0:maxHeatStorageHour
        ...
        CSV.write(joinpath(filePath, "每小每千瓦时热需求_工况2_工质$(refrigerant)_蓄热$(heatStorageHour)h.csv"), df)
        savefig(plt3, joinpath(filePathPower, "工况2_功率变化_工质$(refrigerant)_蓄热$(heatStorageHour)h.png"))
        savefig(plt4, joinpath(filePathHeatStorage, "工况2_蓄热变化_工质$(refrigerant)_蓄热$(heatStorageHour)h.png"))
    end
...
CSV.write(joinpath(pwd(), "calculations", "situation2", "summary.csv"), dfSummary)
savefig(plt5, joinpath(pwd(), "calculations", "situation2", "summary.png"))
