...
for refrigerant in refrigerantList
    ...
    filePath=joinpath(pwd(), "calculations", "situation1","rf$(refrigerant)")
    ...
    for heatStorageHour in 0:maxHeatStorageHour
        ...
        CSV.write(joinpath(filePath, "每小每千瓦时热需求_工况1_工质$(refrigerant)_蓄热$(heatStorageHour)h.csv"), df)
        savefig(plt3, joinpath(filePathPower, "工况1_功率变化_工质$(refrigerant)_蓄热$(heatStorageHour)h.png"))
        savefig(plt4, joinpath(filePathHeatStorage, "工况1_蓄热变化_工质$(refrigerant)_蓄热$(heatStorageHour)h.png"))
        #savefig(plt5, joinpath(pwd(), "calculations", "situation1", "工况1_电价_工质$(refrigerant)_蓄热$(heatStorageHour)h.png"))
    end
...
CSV.write(joinpath(pwd(), "calculations", "situation1", "summary.csv"), dfSummary)
savefig(plt5, joinpath(pwd(), "calculations", "situation1", "summary.png"))
